CREATE OR REPLACE FUNCTION bitemporal_internal.ll_create_bitemporal_table(p_schema text,
p_table text, p_table_definition text, p_business_key text) 
RETURNS BOOLEAN 
AS
 $$
DECLARE 
...
BEGIN
v_business_key_name :=p_table||translate(p_business_key, ', ','_')||'_assert_eff_excl';
